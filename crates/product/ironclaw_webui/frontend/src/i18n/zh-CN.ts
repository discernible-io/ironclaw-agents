...
registerPack("zh-CN", {
  ...
  "chat.statusWorkingBusy": "正在工作…",
  "chat.statusThinking": "正在思考…",
  "chat.statusWriting": "正在撰写…",
  "chat.statusSearching": "正在搜索…",
  "chat.statusReading": "正在阅读…",
  "chat.statusRunningCommand": "正在运行命令…",
  "chat.statusUsingTool": "正在使用 {name}…",
  "chat.identityUser": "你",
