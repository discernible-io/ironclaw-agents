...
use ironclaw_host_runtime::{
    ...
    HostRuntime, HostRuntimeServices, IDCP_CAPABILITY_ID, JSON_CAPABILITY_ID,
    ...
    TRIGGER_RUN_CAPABILITY_ID, TRIGGER_STATUS_CAPABILITY_ID, ToolCallHttpEgress, TriggerCreateHook,
    UserSandboxProcessPort, VisibleCapabilityAccess, VisibleCapabilityRequest,
...
static IDCP_HELPER_TEST_LOCK: LazyLock<std::sync::Mutex<()>> =
...
async fn builtin_idcp_calls_loopback_helper_and_redacts_jwt() {
    ...
    let _guard = IDCP_HELPER_TEST_LOCK.lock().unwrap();
